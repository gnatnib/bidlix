const apiKey = "5f92e60df1341b6a78b343a93c715dc2";
...
function createMovieCard(movie) {
  ...
  const trunctatedTitle =
    original_title.length > 15
      ...
      : original_title;
  const formattedDate = release_date || "N/A";
  const cardTemplate = `
        <div class = "column">
            <div class = "card">
                ...
                <div class = "card-content">
                    <div class = "card-header">
                        <div class="left-content">
                            ...
                            <span style="colorL #12efec">${formattedDate}</span>
                        </div>
                    <div class="right-content">
                        <a href="${imagePath}" target="_blank"
                        class="card-btn" style="color : #fff;">See Cover</a>
                    </div>
                </div>
                <div class="info">
                    ${overview || "N/A"}
